...
if (jssupportticket::$_config['offline'] == 2) {
    if (get_current_user_id() != 0) {
            ...
            if (jssupportticket::$_data['staff_enabled']) {
                ...
                <script type="text/javascript">
                    ...
                    function resetForm() {
                        ...
                        jQuery('#jsst-ticket').val('');
                        jQuery('#jsst-ticketsearchkeys').val('');
                        jQuery('#jsst-from').val('');
                        jQuery('#jsst-email').val('');
                        jQuery('#jsst-departmentid').val('');
                        jQuery('#jsst-priorityid').val('');
                        jQuery('#jsst-subject').val('');
                        jQuery('#jsst-datestart').val('');
                        jQuery('#jsst-dateend').val('');
                        return true;
                    }
                ...
                <div class="js-row">
                    <div class="js-col-xs-12 js-col-md-2 js-myticket-link js-col-md-offset-1">
                    ...
                    <div class="js-col-xs-12 js-col-md-2 js-myticket-link">
                        <a class="js-myticket-link <?php echo $closed; ?>" href="2">
                            <?php 
                    ...
                    <div class="js-col-xs-12 js-col-md-2 js-myticket-link">
                        <a class="js-myticket-link <?php echo $answered; ?>" href="3">
                            <?php 
                    ...
                    <div class="js-col-xs-12 js-col-md-2 js-myticket-link">
                        <a class="js-myticket-link <?php echo $overdue; ?>" href="5">
                            <?php 
                    ...
                    <div class="js-col-xs-12 js-col-md-2 js-myticket-link">
                        <a class="js-myticket-link <?php echo $allticket; ?>" href="4">
                            <?php 
                ...
                <form class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo site_url("?page_id=" . jssupportticket::getPageid() . "&jstmod=ticket&jstlay=staffmyticket"); ?>">
                    ...
                    <div id="js-filter-wrapper-toggle-area">
                        <div class="js-col-md-12 js-filter-wrapper">	
                            <div class="js-col-md-6 js-filter-value"><?php echo JSSTformfield::text('jsst-from', isset(jssupportticket::$_data['filter']['from']) ? jssupportticket::$_data['filter']['from'] : '', array('placeholder' => __('From', 'js-support-ticket'))); ?></div>
                        ...
                        <div class="js-col-md-12 js-filter-wrapper">	
                            <div class="js-col-md-6 js-filter-value"><?php echo JSSTformfield::select('jsst-departmentid', JSSTincluder::getJSModel('department')->getDepartmentForCombobox(), isset(jssupportticket::$_data['filter']['departmentid']) ? jssupportticket::$_data['filter']['departmentid'] : '', __('Select', 'js-support-ticket').' '.__($field_array['department'], 'js-support-ticket')); ?> </div>
                            <div class="js-col-md-6 js-filter-value"><?php echo JSSTformfield::select('jsst-priorityid', JSSTincluder::getJSModel('priority')->getPriorityForCombobox(), isset(jssupportticket::$_data['filter']['priorityid']) ? jssupportticket::$_data['filter']['priorityid'] : '', __('Select', 'js-support-ticket').' '.__($field_array['priority'], 'js-support-ticket')); ?></div>
                        </div>
                        <div class="js-col-md-12 js-filter-wrapper">    
                            <div class="js-col-md-12 js-filter-value"><?php echo JSSTformfield::text('jsst-subject', isset(jssupportticket::$_data['filter']['subject']) ? jssupportticket::$_data['filter']['subject'] : '', array('placeholder' => __($field_array['subject'], 'js-support-ticket'))); ?></div>
                        </div>
                        <?php if(JSSTincluder::getJSModel('userpermissions')->checkPermissionGrantedForTask('View User')){ ?>
                                <div class="js-col-md-12 js-filter-wrapper">	
                                    <div class="js-col-md-12 js-filter-value"><?php echo JSSTformfield::select('staffid', JSSTincluder::getJSModel('staff')->getStaffForCombobox(), isset(jssupportticket::$_data['filter']['staffid']) ? jssupportticket::$_data['filter']['staffid'] : '', __('Select staff','js-support-ticket')); ?></div>
                                </div>
                        <?php } ?>
                        <div class="js-col-md-12 js-filter-wrapper">	
                            <div class="js-col-md-4 js-filter-value"><?php echo JSSTformfield::text('jsst-datestart', isset(jssupportticket::$_data['filter']['datestart']) ? jssupportticket::$_data['filter']['datestart'] : '', array('class' => 'custom_date', 'placeholder' => __('Start Date', 'js-support-ticket'))); ?></div>
                            <div class="js-col-md-4 js-ticket-special-character js-nullpadding">-</div>
                            <div class="js-col-md-4 js-filter-value"><?php echo JSSTformfield::text('jsst-dateend', isset(jssupportticket::$_data['filter']['dateend']) ? jssupportticket::$_data['filter']['dateend'] : '', array('class' => 'custom_date', 'placeholder' => __('End Date', 'js-support-ticket'))); ?></div>
                        </div>
                        <?php 
                    ...
                    <div class="js-col-md-12 js-filter-wrapper">
                        <div class="js-filter-button">
                            ...
                            <?php echo JSSTformfield::submitbutton('jsst-reset', __('Reset', 'js-support-ticket'), array('class' => 'button', 'onclick' => 'return resetForm();')); ?>
                        </div>
                    </div>
                ...
                <?php
                $link = site_url('?page_id=' . jssupportticket::getPageid() . '&jstmod=ticket&jstlay=staffmyticket&list=' . jssupportticket::$_data['list']);
                            ...
                            <div class="js-col-xs-12 js-col-md-12 js-ticket-toparea">
                                <div class="js-col-xs-2 js-col-md-1 js-ticket-pic">
                                    <?php if ($ticket->staffphoto) { ?>
                                        <img  src="<?php echo site_url('?page_id='.jssupportticket::getPageid().'&action=jstask&jstmod=staff&task=getStaffPhoto&jssupportticketid='.$ticket->staffid ); ?>">
                                    <?php } else {
                        ...
                        <?php echo $status; ?>
                                ...
                                <div class="js-col-xs-12 js-col-md-4 js-ticket-data1 js-ticket-padding-left-xs">
                                    ...
                                    <div class="js-row">
                                        ...
                                        <div class="js-col-xs-6 js-col-md-6 js-col-xs-6 js-ticket-wrapper-textcolor" style="background:<?php echo $ticket->prioritycolour; ?>;"><?php echo $ticket->priority; ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        $redirect_url = site_url('?page_id='.jssupportticket::getPageid().'&jstmod=ticket&jstlay=staffmyticket');
