...
?>
<span class="js-adminhead-title"> <a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=reports&jstlay=userreport');?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a> <span class="jsheadtext"><?php echo __("Report By User", 'js-support-ticket') ?></span>
...
<?php 
	$staff = jssupportticket::$_data['user_report'];
	if(!empty($staff)){ ?>		
