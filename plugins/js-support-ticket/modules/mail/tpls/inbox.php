        ...
        if (get_current_user_id() != 0) {
            if (JSSTincluder::getJSModel('staff')->isUserStaff()) {
                if (jssupportticket::$_data['staff_enabled']) {
                    ...
                    <h1 class="js-ticket-heading"><?php echo __('Inbox', 'js-support-ticket') ?></h1>
                    ...
                    <?php echo "<input type='hidden' name='jstlay' value='inbox'/>"; ?>
                        <div class="row js-filter-wrapper">
                            <div class="js-col-md-12">
                                <div class="js-col-md-12 js-col-xs-12 js-filter-title">
                    <?php echo __('Subject', 'js-support-ticket'); ?>
                                </div>
                                <div class="js-col-md-12 js-col-xs-12 js-filter-value">
                    <?php echo JSSTformfield::text('jsst-subject', JSSTrequest::getVar('jsst-subject'), array('placeholder' => __('Subject', 'js-support-ticket'))); ?>
                                </div>
                            </div>
                            <div class="js-col-md-12 js-col-xs-12 js-filter-wrapper">
                    ...
                    <div class="js-filter-add-button">
                        <span><a class="js-add-link button active" href="index.php?page_id=<?php echo jssupportticket::getPageid(); ?>&jstmod=mail&jstlay=inbox"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/inbox.png">  <?php echo __('Inbox', 'js-support-ticket').' (';
                    echo $inbox;
                    echo ' )'; ?></a></span>
                    ...
                    <?php if (!empty(jssupportticket::$_data[0]['inbox'])) { ?>  		
                        <div class="js-filter-form-list">
                            <div class="js-filter-form-head js-filter-form-head-xs">
                                ...
                                <div class="js-col-md-3 js-col-xs-12"><?php echo __('From', 'js-support-ticket'); ?></div>
                            ...
                            foreach (jssupportticket::$_data[0]['inbox'] AS $inbox) {
                                ...
                                echo " : "; ?></span><a href="index.php?page_id=<?php echo jssupportticket::getPageid(); ?>&jstmod=mail&jstlay=message&jssupportticketid=<?php echo $inbox->id; ?>"><?php echo $inboxtitle; ?></a></div>
                                    <div class="js-col-md-3 js-col-xs-12" ><span class="js-filter-form-data-xs"><?php echo __('From', 'js-support-ticket');
                                ...
                                echo " : "; ?></span><?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($inbox->created)); ?></div>
                                    <div class="js-col-md-3 js-col-xs-12 js-filter-form-action-hl-xs">
                                        <a href="index.php?page_id=<?php echo jssupportticket::getPageid(); ?>&jstmod=mail&jstlay=message&jssupportticketid=<?php echo $inbox->id; ?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
                                        ...
                                        <a href="index.php?page_id=<?php echo jssupportticket::getPageid(); ?>&jstmod=mail&task=markasread&action=jstask&mailid=<?php echo $inbox->id; ?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/mark_read.png" /></a>&nbsp;&nbsp;
                                        <a href="index.php?page_id=<?php echo jssupportticket::getPageid(); ?>&jstmod=mail&task=markasunread&action=jstask&mailid=<?php echo $inbox->id; ?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/mark_unread.png" /></a>
                                    </div>
                                </div>
                            <?php }
                        ?>
            ...
            $redirect_url = site_url('?page_id='.jssupportticket::getPageid().'&jstmod=mail&jstlay=inbox');
