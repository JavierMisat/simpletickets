...
class Custom_WC_Widget_Product_Tag_Cloud extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Your most used product tags in cloud format.', 'alaska' );
		$this->widget_id          = 'woocommerce_product_tag_cloud';
		$this->widget_name        = __( 'WooCommerce Product Tags', 'alaska' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Product Tags', 'alaska' ),
