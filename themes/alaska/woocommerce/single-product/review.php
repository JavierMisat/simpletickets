        ...
        <div class="comment-text">
            ...
            <?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) : ?>
                ...
                <div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating"
                     title="<?php echo sprintf( __( 'Rated %d out of 5', 'alaska' ), $rating ) ?>">
                    <span style="width:<?php echo ( $rating / 5 ) * 100; ?>%"><strong
                            itemprop="ratingValue"><?php echo $rating; ?></strong> <?php _e( 'out of 5', 'alaska' ); ?></span>
                </div>
            ...
            <?php if ( $comment->comment_approved == '0' ) : ?>
                ...
                <p class="meta"><em><?php _e( 'Your comment is awaiting approval', 'alaska' ); ?></em></p>
            ...
            <?php else : ?>
                ...
                <p class="meta">
                    ...
                    if ( get_option( 'woocommerce_review_rating_verification_label' ) === 'yes' ) {
                        if ( $verified ) {
                            echo '<em class="verified">(' . __( 'verified owner', 'alaska' ) . ')</em> ';
                        }
                    }
